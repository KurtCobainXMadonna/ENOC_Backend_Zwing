...
INSERT INTO sound_presets (sound_id, name, category, blob_url, description) VALUES
    ('b1000000-0000-0000-0000-000000000001', 'Basic 808 Kick',  'KICK',  'https://zwingblob32125.blob.core.windows.net/audio-presets/Basic 808 Kick.wav',  'Classic 808 style kick drum'),
    ('b1000000-0000-0000-0000-000000000002', 'Basic 808 Snare', 'SNARE', 'https://zwingblob32125.blob.core.windows.net/audio-presets/Basic 808 Snare.wav', 'Classic 808 style snare drum'),
    ('b1000000-0000-0000-0000-000000000003', 'Basic 808 Clap',  'CLAP',  'https://zwingblob32125.blob.core.windows.net/audio-presets/Basic 808 Clap.wav',  'Classic 808 style clap'),
    ('b1000000-0000-0000-0000-000000000004', 'Basic 808 HiHat', 'HIHAT', 'https://zwingblob32125.blob.core.windows.net/audio-presets/Basic 808 HiHat.wav', 'Classic 808 style closed hi-hat'),
    ('b2000000-0000-0000-0000-000000000001', 'CB Kick',         'KICK',  'https://zwingblob32125.blob.core.windows.net/audio-presets/CB_Kick.wav',         'Punchy CB series kick'),
    ('b2000000-0000-0000-0000-000000000002', 'CB Snare',        'SNARE', 'https://zwingblob32125.blob.core.windows.net/audio-presets/CB_Snare.wav',        'Crisp CB series snare'),
    ('b2000000-0000-0000-0000-000000000003', 'CB Clap',         'CLAP',  'https://zwingblob32125.blob.core.windows.net/audio-presets/CB_Clap.wav',         'Clean CB series clap'),
    ('b2000000-0000-0000-0000-000000000004', 'CB Hat',          'HIHAT', 'https://zwingblob32125.blob.core.windows.net/audio-presets/CB_Hat.wav',          'Sharp CB series hi-hat');
